...
/*
   preconditions for using this class
      the operator << must be overloaded for the type stored in the list
      the operator == must be overloaded for the type stored in the list
*/
...
public:
    ...
    arrayListType (const arrayListType& otherList); 
       //copy constructor
    const arrayListType& operator=(const arrayListType& other);
       // operator=
    ~arrayListType();
      //destructor
      //Deallocate the memory occupied by the array.

     void traversal( void (*) (ITEM&) );
...
/**************************** IMPLEMENTATION ****************************/
template <class T>
void arrayListType<T>::traversal
...
template <class Type>
void arrayListType<Type>::insertEnd(Type insertItem)
{
...
// operator = 
template <class ITEM>
const arrayListType<ITEM>& arrayListType<ITEM>::operator=
                        (const arrayListType<ITEM>& other)
{
   if (this == &other)
      return *this;
   delete [] list;
