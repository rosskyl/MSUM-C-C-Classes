...
void dump(char *start,char *end)
{
   ...
   const int adjust = 8;  // used to align addresses output to last digit 0
   const int startline = 0; // used to adjust the number of lines output
   const int endline = 3; // used to adjust the number of lines output
   int num = start-end;
